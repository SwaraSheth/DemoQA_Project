...
public class WidgetsProgressbar {
	...
	public void clickElement(WebDriver driver) throws InterruptedException {
		...
		JavascriptExecutor js= (JavascriptExecutor) driver;
		 ...
		 driver.findElement(By.xpath("/html[1]/body[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[4]/div[1]/ul[1]/li[5]")).click();
		 WebElement element1=driver.findElement(By.xpath("//*[@id=\"progressBarContainer\"]/h1"));
		 js.executeScript("arguments[0].scrollIntoView();", element1);
		 Thread.sleep(3000);
	}
	
	@Test(priority = 2)
	public void ProgressBar(WebDriver driver) throws InterruptedException {
